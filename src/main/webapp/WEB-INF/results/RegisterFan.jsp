...
<head>
    ...
    <title>SoccerHub - Registrazione Tifoso</title>
            ...
            <section class="form-container">
                ...
                <div class="user-type-selection">
                    ...
                    <div class="user-type-buttons">
                        ...
                        <a href="${pageContext.request.contextPath}/inizio?action=register&type=fan" class="btn btn-active">Tifoso</a>
                    </div>
                </div>
                ...
                <form action="${pageContext.request.contextPath}/registrazione" method="post" class="registration-form">
                    ...
                    <div class="form-group">
                        ...
                        <% if(request.getAttribute("birthCityError") != null) { %>
                        <span class="error"><%= request.getAttribute("birthCityError") %></span>
                        <% } %>
                    </div>
                    
                    <div class="form-group">
                        <label for="residenceCity">Città di Residenza</label>
                        <input type="text" id="residenceCity" name="residenceCity" required>
                        <% if(request.getAttribute("residenceCityError") != null) { %>
                        <span class="error"><%= request.getAttribute("residenceCityError") %></span>
                        <% } %>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <% if(request.getAttribute("provinceError") != null) { %>
                        <span class="error"><%= request.getAttribute("provinceError") %></span>
                        <% } %>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <span class="error"><%= request.getAttribute("streetError") %></span>
                        <% } %>
                    </div>
